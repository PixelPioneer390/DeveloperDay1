...
const IdentityDashboard = () => {
        ...
        <div className="grid grid-cols-4 gap-4">
          {tabs.map(({ label }, index) => (
            <div
              key={label}
              className={`${
                index > 0 ? "border-l border-gray-800 h-48" : ""
              } pl-4 first:pl-0`}
            >
  ...
  return (
    <div className="min-h-screen text-white font-sans">
      <div className="max-w-7xl mx-auto p-8 rounded-xl overflow-hidden relative">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-900/40 via-gray-900 to-blue-900/40 opacity-80"></div>

        <div className="relative z-10">
          <h1 className="text-5xl font-semibold mb-2 max-w-2xl leading-tight">
          ...
          {/* Footer */}
          <div className="mt-16 pt-8 flex justify-between items-end flex-wrap gap-4">
            <div>
